...
//---mysqli_query(conexion, sententciaSQL)
  mysqli_query($conexion, "insert into cursos(nombrecurso) values 
                  ('$_REQUEST[curso]')")// En caso que MySql detecte un error, retorna false la función mysqli_query, por lo que se ejecuta la instrucción posterior al or
...
// sucede para el nombre y el mail; en cambio, para el codigocurso esto no debe ser así
  ...
  echo "<h2> El curso $_REQUEST[curso] fue registrado exitosamente </h2>";
  ?>
</body>
</html>